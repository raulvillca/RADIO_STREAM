...
public class FavouriteAdapter extends BaseAdapter {
    ...
    private IComunicationList comunication;

    public FavouriteAdapter(AppCompatActivity context, List<Item> items) {
        this.items = items;
        this.activity = context;
        this.comunication = (IComunicationList) activity;
    }
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ShareFactory.setList(activity, items.get(i).getId(), checkBox.isChecked());

                //descheckeamos un favorito, lo quitamos de la lista y actualizamos
                items.remove(i);
                notifyDataSetChanged();
                comunication.updateList();
            }
        });
